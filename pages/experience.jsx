      ...
      <div className="h-flex">
        ...
        <div className="d-flex m-2">
          ...
          <div className="flex-grow-1 ms-3">
            <h5>Project RPG</h5>
            <p>
              RPG game that use libGDX framework write in Java language.
              It&apos;s sophomore project that not fully finish and pretty far
              for the development plan goal. I&apos;m the project manager.
            </p>
          </div>
        </div>
        {/* <!-- Container --> */}
        <div className="d-flex m-2">
          ...
          <div className="flex-grow-1 ms-3">
            ...
            <p>
              ...
              focus on making friend rather than find dating person. It&apos;s
              Junior project and I write back-end specifically I write about
              register form and set up firebase App to sync app and database.
            </p>
          </div>
        </div>
      </div>
